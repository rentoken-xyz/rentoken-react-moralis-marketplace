...
async function main() {
    await Moralis.start({
        serverUrl: "https://tm9ltqmmwggb.usemoralis.com:2053/server",
        appId: "3myjdpDbSDc5ymT3Wgn6bWPEpSRxCg2wZGdq5pRb",
        masterKey: "9jTQgfYCaSBtw2IH0Sig41WhTAvq7x3cMYgnhbsr",
    });
